...
Does speculation facilitate price discovery or instability?  If it is orice discovery, it is beneficial and should be encouraged; if it is instability, welfare is enhanced by its reduction. This paper seeks to distinguish between these two characteristics by analysing those times when specualtion in the foreign exchange market is most extreme.  A series of event studies are conducted on the extremes of speculative activity and speculative sentiment. The finding that spculative extremes do not provide information about subsequent returns implies that specualtion is part of the process of price discovery and that efforts to reduce it would leave to a reduction in information efficiency. 

If markets are effective, speculation is a stabilising force, providing liquidity and helping to ensure that markets swiftly find equilibrium. i\citet{KeynesHedge} and \citet{HicksHedge} emphasise the role that speculation plays in providing liquidity and say that there is a return to this activity. Speculators provide a service for a fee that is determined by the difference between the price that they buy and the price at which they expect to sell.  Informed speculators will tend to drive out the uninformed noise-traders.  \citet{FriedmanPositive} asserted that successful speculators would be those buying below intrinsic value and selling above that rate. Therefore, Friedman argued, the speculative process would reward those able to access or utilise information relative to the uninformed and, through a Darwinian process, informed speculation would dominate.  This view regards speculation as an key lubricant of financial markets as it provides liquidity and facilitates the process of price discovery whereby information is assimilated into price.   

However, the later Keynes regarded speculation as a myopic, sentiment-driven activity, dominated by the desire to ``beat the gun'' or  ``outwit the crowd'\citet[p. 101]{Keynes1936}. Speculation was a problem that would cause booms, reversals and would discourage fundamental, long-term investment. Speculation would emerge from the evolution of collective sentiment and could create trends in financial asset prices. 

This paper distinguishes between the two concepts of speculation by investigating the relationship between the intensity of speculation and the weight of speculative positions relative to the movement of prices in the foreign exchange market\footnote{\label{FX}The foreign exchange market is chosen for this study because it is the largest and most liquid financial market in the world.  The latest survey taken by the Bank for International Settlements (BIS) in April 2013 estimated average daily turnover at \$5.4trn with average daily spot transactions of \$2.0trn See \citet{BISFX2013}.  The cost of trading in this market, when measured in terms of the size of the bid-ask spread, is extremely low. An analysis by \citet{Steely2013} of the bid-ask spreads for USD-JPY, GBP-USD and EUR-USD for the period January 2001 to 2005 finds that the average spread for each is 0.342\%, 0.305\% and 0.326\% respectively.  This would be the cost for a round-trip (buying and selling immediately).}.  If speculators are uninformed and their activity can be regarded as noise, the most extreme speculative sentiment and the time when speculators have the greatest weight in the market should correspond with the greatest deviation of prices from fundamental value, when reversals are most likely to take place; if speculators are informed their activity drives exchange rates towards equlibrium and prices should follow a random walk after these extremes.  

The price action after periods of extreme speculative sentiment and extreme speculative positions are comparded to the results of a noise-trader model.  Noise-trader reversals in price are not evident.  However, there is evidence that speculation in the foreign exchange market is informed. The paper contributes to the understanding of speculation and uses a unique set of option prices to identify the intensity of speculative sentiment
...
\citet{EasleyPIN2} propose to measure informed market activity with the bid-ask spread.  Large orders are assumed to be informed as participants seek to explit their informational advantage.\footnote{Market-makers use Bayes' Rule to update their fundamental valuation by using order flow to estimate the joint probability that there has been an information event and that it has been good news or bad news, the authors seek to operationalise the following model:
\begin{subequations}
\begin{equation}
...
Informed speculation is also central to the mechanism proposed by \citet{muth1961Rational} to facilitate \emph{rational expectations}. Those economic agents able to determine fundamental value will be able to speculate and drive prices towards equilibrium.    While this construction may be justified for the analysis of microstructure and market efficiency, it is an over-simplification that is inappropriate when seeking more understanding of speculation itself.  Institutional and psychological explanations for noise-trading frequently suggest that there are endogenous non-random elements to speculative activity.
