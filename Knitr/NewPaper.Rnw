...
% does this following paragraph come later?  I think so....Once the three
% main categories are done. 
...
%
 \citet[p.529]{BlackNoise} suggested that this combination was essential to the smooth function of financial markets. It is ``the arbitrary element in expectations''. Therefore, noise makes financial markets possible but imperfect: the more noise-traders that there are, the more liquidity and the easier it is to trade; the more noise-traders, the higher the level of inefficiency in the market and the more likely that price will be driven from fundamental value. 
  ...
  Speculation is also an important part of the argument for why prices should tend towards a level that consistent with \emph{the rational expectations equilibrium} (RER). This is the level that is consistent with rational expectations.  In the original version of rational expectations,  \citet{muth1961Rational} uses commodity speculation as the means by which prices are driven towards the level where expectations are model-consistent. These are of Friedman-type speculators as they base their expectations on their knowledge of the underlying model and they are the means by which the components of the model tend towards equilibrium values.  
% See \citet gc{Lyons2006Microstructure} and \citep{Evans2002Order} for examples of the micrstrucure approach in foreign exchange.  

However, though the idea that noise is a random variable may be a construction that is useful for modelling and it may be justified in analysis of broader themes of microstructure and levels of market efficiency, this exogenous construct may be an over-simplification that is inappropriate when looking for more understanding of speculation itself.  Institutional and psychological explanations for noise-trading frequently suggest that there are endogenous non-random elements.
...
it has also been suggested that speculative techniques can change overtime.  For example, \citet{ShillerFashion} discusses the use of fashionable techniques or fads in investment.  In this way, speculation noise is associated with sentiment and measures of sentiment are then used as ways of measuring speculation. 
%It would be good to have some more modern ideas here.  Maybe they are just the empirical results. 
%this paragraph is not very good.  It needs to be updated.  Look at the file in citulike. 
...
The Keynesian view of speculation is that it is an addition to market noise that makes it even harder for informed-traders to overcome uncertainty and apply fundamental information about long-term value. This description provides an explanation for Shiller's observation that stock prices are more volatile than the underlying earnings information on which valuation should be based \citet{ShillerVol}. In addition, \citet{Delong1990noise} and \citet{shleifer1997limits} show that constrained horizons can cause noise-trading to limit the ability of informed traders to take advantage of profitable opportunities for fear of further divergence from fundamental value before realignment is achieved.

  The nature of speculation and the role of noise-traders has become increasingly important since the global financial crisis (GFC).  There are a number of contemporary questions where the role and nature of speculation is at the centre of the debate.  Regulations or taxes that reduce the amount of speculation have generally been considered to be beneficial as they reduce risk and encourage more long-term attitudes towards investment.  However, where these measures reduce liquidity, higher risk and an increase in other costs may provide an countervailing force. 
...
\section{Methodology}
The aim of this study is to test whether the noise-trader model provides an appropriate explanation for speculator activity in the  foreign exchange market. This will be use to gain a fuller understanding of speculative behaviour.   The experiment will involve three steps:  assess the price implication of the noise-trader model;  measure speculative activity in the foreign exchange market; finally, assess whether extreme speculative activity in the foreign exchange market is consistent with the noise-trader model.  If the speculative activity that is seen in the foreign exchange market produces results that are like the noise-trader model, it can be said that speculation is noise trading as Keynes asserted, if not it may be more informed as suggested by Friedman.  
% where it is widely perceived that there are a relatively large number of traders engaged in technical analysis.  See \citet gc{FrootChartists} for a survey.  %this may go in the explanation for why fx is used.  Use this elsewhere. Add more?  

The \citet{Delong1990noise} noise-trader model used in this study. This is a derivative of the \citet{Samuelson1958} overlapping generations model  with two-period agents making a portfolio choice.  There are two assets:  a safe asset $(s)$ which pays a set dividend $(d)$ and is in perfectly elastic supply; the risky asset $(u)$ also pays the same dividend but is not in elastic supply.  There are two types of investor or trader: sophisticated traders $(i)$ who know the fundamental value of the risky assets and noise-traders $(n)$ who misperceive the fundamental value.  In the absence of noise-traders, the assets are substitutes.  Each trader chooses their portfolio in the first period $(t)$ to maximise their utility on the basis of their belief about the price of the unsafe asset in the second period $(t + 1)$.  The representative noise-trader mistakes the price of the risky asset by a random variable 
...
The Friedman-effect and the Price-pressure are the effects that are studied here.  Their combination suggests that when the weight of noise-traders is high or the times when they have particularly strong opinions will tend to be those when there is the greatest risk of reversals.  The hold-more effect suggests that the weight of speculative involvement in the market will tend to increase as a trend.  Create-space effect would suggest that when the weight of noise-traders is high, there is increased risk.  %this can be assessed. 

The main findings are that noise-traders will not necessarily disappear as Friedman had suggested \citet{FriedmanPositive}.  While noise-traders will tend to get less utility than sophisticated traders, this does not necessarily drive them from the market.  The noise-traders expected to get higher utility due to their misperception.  The reduction in utility comes mainly from the fact that they are not compensated for taking risk that they are not aware of.  This is consistent with the type of over-confidence that has been found by \citet{odean1998volume}in day-traders.
