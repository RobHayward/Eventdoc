...
There are a range of ideas about the way that speculation can affect financial markets.  Towards one end of this spectrum is the view of Keynes from Chapter 12 of \emph{The General Theory} where he identified speculation as a myopic, sentiment-driven activity, dominated by the desire to ``beat the gun'' or  ``outwit the crowd'' \citet[p. 101]{Keynes1936}. Here speculation is a problem that, at its most extreme, will cause booms, reversals and will discourage fundamental, long-term investment. It is noise that does not emerge randomly, but feeds off itself in an evolution of collective sentiment that encourages trends in asset prices.
...
One key element of the microstructure literature involves distinguishing between uninformed or noise-traders and those who have information. The \citet{Kyle1985Continuous} model has market-makers receiving orders from the informed and the uninformed.  On the assumption that the uniformed arrive in a random fashion without any reason to trade, the weight of orders implies something about the activity of the informed and causes prices to change in the process of price discovery.  The bid-ask spread is the payment that the market-maker receives in return for taking the risk of meeting an informed trader.  Ultimately, the uninformed traders make payments to the informed traders with the mark-makers taking a cut for the risk and the provision of exchange.  See also \citet{glosten1985bid}.  

In the \emph{microstructure} literature, the term noise-trader is often interchanged with \emph{liquidity-trader}.  They do not usually distinguish between institutional and psychological reasons for the lack of attention to fundamental information. Nonetheless, liquidity tends to refer to institutional explanations for trading without reference to fundamental value. This may mean that economic agents just execute customer orders at the current price or it may be that they buy and sell with reference to a benchmark index or to fulfil a hedging strategy.

\citet[p. 1]{GortonNoise} categorise noise-traders as all those trading in markets for ``non-information-based reasons''. In this case, uninformed speculation provides a rational and an opportunity for the trading of financial securities. If all economic agents know the fundamental value of a security how can some be buying and some be selling? There must be different opinions.  Why will traders be prepared to pay the cost of acquiring information if they are unable to take advantage of that information? With speculative noise-traders, the informed can take advantage of their information.  This creates a justification for acquiring information. Speculative noise-traders can therefore create a gap between the price and the fundamental value that will encourage informed traders to pay the cost of acquiring information. The divergence between this price and fundamental value is thereby essential to encourage the process of price discovery. 
%
 \citet[p.529]{BlackNoise} suggested that this combination was essential to the smooth function of financial markets. It is ``the arbitrary element in expectations''. Therefore, noise makes financial markets possible but imperfect: the more noise-traders that there are, the more liquidity and the easier it is to trade; the more noise-traders, the higher the level of inefficiency in the market and the more likely that price will be driven from fundamental value. This begs the question: are speculators trading on noise or are they informed?  

  Speculation is also an important part of the argument for why prices should tend towards a level that consistent with \emph{the rational expectations equilibrium} (RER). This is the level that is consistent with rational expectations.  In the original version of rational expectations,  \citet{muth1961Rational} uses commodity speculation as the means by which prices are driven towards the level where expectations are model-consistent. These are of Friedman-type speculators as they base their expectations on their knowledge of the underlying model and they are the mechanisem through which equilibrium is achieved.  

However, though equating noise and noise-trading as a random variable may be a construction that is useful for modelling and it may be justified in analysis of broader themes of microstructure and levels of market efficiency, it may also be an over-simplification that is inappropriate when looking for more understanding of speculation itself.  Institutional and psychological explanations for noise-trading frequently suggest that there are endogenous non-random elements to speuclative activity.

The institutional explanations are associated with the allocation of credit for investment and trading purposes:  as asset values decline exchanges, banks and other providers of liquidity require larger margins and deeper haircuts; investors liquidate their fund holdings; the attraction of hedging increases.  See \citet{BrunnermeierLiquidity} and \citet{Gorton} for an overview of the institutional literature.  Psychological explanations revolve around the common panic, the group-thinking and the tendency to read private information from the actions of other investors: the so-called \emph{wisdom of crowds} depends on independent evaluation but as Keynes noted in his discussion of the \emph{beauty contest}, it is generally more important to identify what other investors will believe than actual underlying, fundamental value \citet[p.101]{Keynes1936}.
...
It has also been suggested that speculative techniques can change over time.  For example, \citet{ShillerFashion} discusses the use of fashionable techniques or fads in investment.  In this way, speculation noise is associated with sentiment and measures of sentiment are then used as ways of measuring speculation. 
...
The Keynesian view of speculation is that it is an addition to market noise that makes it even harder for informed-traders to overcome uncertainty and apply fundamental information about long-term value. As such, it exacerbates the tendency towards putting too much emphasis on the immediate and works against longer-term and strategic thinking.  This description provides an explanation for Shiller's observation that stock prices are more volatile than the underlying earnings information on which valuation should be based \citet{ShillerVol}. In addition, \citet{Delong1990noise} and \citet{shleifer1997limits} show that constrained horizons can cause noise-trading to limit the ability of informed traders to take advantage of profitable opportunities for fear of further divergence from fundamental value before realignment is achieved.

The nature of speculation and the role of noise-traders has become increasingly important since the global financial crisis (GFC).  There are a number of contemporary questions where the role and nature of speculation is at the centre of the debate.  For example, regulations or taxes that reduce the amount of speculation have generally been considered to be beneficial as they reduce risk and encourage more long-term attitudes towards investment.  However, where these measures reduce liquidity, higher risk and an increase in other costs may provide an countervailing force. 
...
\section{Methodology}
The aim of this study is to test whether the noise-trader model provides an appropriate explanation for speculator activity in the foreign exchange market. This will be used to gain a fuller understanding of speculative behaviour.   The analysis will involve three steps:  assessement of the price implication of the noise-trader model;  measurement of speculative activity in the foreign exchange market; finally, assessement of whether extreme speculative market activity is consistent with the noise-trader model.  If the speculative activity that is seen in the foreign exchange market produces results that are like the noise-trader model, it can be said that speculation is noise trading as Keynes asserted, if not it may be more informed as suggested by Friedman.  

The \citet{Delong1990noise} noise-trader model used in this study. This is a derivative of the \citet{Samuelson1958} overlapping generations model with two-period agents making a portfolio choice between two assets: a safe asset $(s)$ which pays a set dividend $(d)$ and is in perfectly elastic supply; a risky asset $(u)$ also pays the same dividend but is not in elastic supply.  There are two types of investor: sophisticated traders $(i)$ who know the fundamental value of the risky assets and noise-traders $(n)$ who misperceive the fundamental value.  In the absence of noise-traders, the assets are substitutes.  Each trader chooses their portfolio in the first period $(t)$ to maximise their utility on the basis of their belief about the price of the unsafe asset in the second period $(t + 1)$.  The representative noise-trader mistakes the price of the risky asset by a random variable 
