...
One key element of the microstructure literature involves distinguishing between uninformed or noise-traders and those who have infomration. The \citet{Kyle1985Continuous} model has market-makers reciving orders from the informed and the uninformed.  On the assumption that the uniformed arrive in a random fashion without any reason to trade, the weight of orders implies something about the activity of the informed and causes prices to change in the process of price discovery.  The bid-ask spread is the payment that the market-maker recieves in return for taking the risk of meeting an informed trader.  Ultimately, the uninformed traders make payments to the informed traders with the mark-makers taking a cut for the risk and the privision of exchange.  See also \citet{glosten1985bid}.  
...
The institutional explanations are assciated with the allocation of credit for investment and trading purposes:  as asset values decline exchanges, banks and other providers of liqudiity require larger margins and deeper haircuts; investors liquidate their fund holdings; the atttraction of hedging increases.  See \citet{BrunnermeierLiquidity} and \citet{Gorton} for an overview of the institutional literature.  Psychological explanations revolve around the common panic, the group-thining and the tendency to read private information from the actions of other investors: the so-called \emph{wisdom of crowds} depends on independent evaluation but as Keynes noted in his discussion of the \emph{beauty contest}, it is generally more important to identify what other investors will believe than acertain underlying, fundamental value \citet[p.101]{Keynes1936}
 
it has also been suggested that speculative technieques can change overtime.  For example, \citet{ShillerFashion} discusses the use of fashionable techniques or fads in investment.  In this way, speculation noise is associated with sentiment and measures of sentiment are then used as ways of measuring speculation. 
...
Empirical assessment of speuclation has been limited by the scarcity of data.  It is not very easy to distinguish between speculators and other types of investors.  It is even harder to distinguish those that may be noise-traders from those assumed to be informed.  One approach has been to assume that noise-traders utilise simple investment strategies and to use tests of these strategies as a means of testing speculation.  For example speculation can be identified with momentum trading. It is also possible to assume that certain investors, such as investment banksa and hedge funds, are informed while other trade without inforation. The latter group may include day-traders or private individuals.  
