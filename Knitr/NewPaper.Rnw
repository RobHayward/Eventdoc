...
\maketitle
\begin{abstract}
 Uninformed speculation based on noise should lead to price reversals; informed speculation is sustainable. A unique set of option prices measure speculative sentiment while regulatory positions determine the weight of speculative activity.  An event study shows that extremes of speculative sentiment or speculative activity do not increase the probability of price reversal.  Price activity after the extreme is close to a random walk. This supports the view that speculation is part of the price-discovery process.      
\end{abstract}
\section*{Introduction}
Ideas about the way that speculation affects financial market span a broad range.  Towards one end is the Keynesian view that speculation is a myopic, sentiment-driven activity, dominated by the desire to ``beat the gun'' or  ``outwit the crowd'' \citet[p. 101]{Keynes1936}. Speculation is a problem that will cause booms, reversals and will discourage fundamental, long-term investment; It is noise that emerges from the interaction of collective sentiment to encourages trends in asset prices.

Towards the other end of the spectrum, Friedman argued that speculation was a stabilising force, providing liquidity and helping to ensure that markets swiftly find equilibrium. \citet{FriedmanPositive} asserted that successful speculators would be those who managed to correctly buy when prices  were below fundamental value and sell above that price. Therefore, Friedman argued, the speculative process would reward those able to access or utilise information relative to the uninformed and, through a Darwinian process, informed speculation would dominate.  This view regards speculation as an key lubricant of financial markets as it provides liquidity and facilitates the process of price discovery.   

The aim of this paper is to understand more about the nature of speculation by investigating the relationship between the intensity of speculation and the weight of speculative positions relative to the movement of prices in the foreign exchange market\footnote{The foreign exchange market is utilised because it is the largest and most liquid financial market in the world.  The latest survey taken by the Bank for International Settlements (BIS) in April 2013 estimated average daily turnover at \$5.4trn with average daily spot transactions of \$2.0trn See \citet{BISFX2013}.  The cost of trading in this market, when measured in terms of the size of the bid-ask spread, is extremely low. An analysis by \citet{Steely2013} of the bid-ask spreads for USD-JPY, GBP-USD and EUR-USD for the period January 2001 to 2005 and finds that the average spread for each is 0.342\%, 0.305\% and 0.326\% respectively.  This would be the cost for a round-trip (buying and selling immediately).}.  If speculators are uninformed and their activity can be regarded as noise, the most extreme sentiment and the time when speculators have the greatest weight in the market should correspond with the greatest deviation of prices from fundamental value, when reversals are most likely to take place; if speculators are informed prices should follow a random walk after either of these extremes.  

This paper contributes to the debate about the nature of speculation in a number of ways. A unique set of option prices are used to identify the intensity of speculative sentiment; an event study method is used to establish the effect of extremes of speculative sentiment and speculative positions; these speculative extremes are compared to a common noise-trader model.  Speculative extremes do not provide information about the future; the evolution of foreign exchange prices after an extreme can be characterised as a random walk; this suggests that speculation is part of the process of price discovery.  

For example, Figure \ref{fig:ES1} show the evolution of a selection of foreign exchange prices after an extreme reading of speculative sentiment. Sentiment is measured by an extreme in the price of currency call options relative to the equivalent put.  It is clear that the foreign exchange rate has a contemporaneous movement with the sentiment but that after reading the extreme, there is no clear direction.  The lack of clear direction indicates lack of information.  As such, extreme speculative positions do presage reversals, indicating that they are not associated with divergence from equilibrium. 

\begin{figure}
\graphicspath{{../Figures/}}
\centering
\includegraphics[scale=0.6]{RRCum16}
\caption{Event Study:  Extreme (High 99th percentile) Risk Reversal Skew and 16 day event window: Risk reversals are the ratio of implied volatility on calls to the equivalent put; extreme high is the highest 99th percentile for the whole range, cumulative returns are the sum of log exchange rate returns.  The event day is the day of the extreme risk reversal reading as a proxy for extreme speculative sentiment.  If speculation is uninformed, extremes should be followed by reversals; if speculation is informed, extremes are more likely to be followed by a random walk.}
\label{fig:ES1}
\end{figure}
% This description provides an explanation for the observation from \citet{ShillerVol} that stock prices are more volatile than the underlying earnings information on which valuation should be based. In addition, \citet{Delong1990noise} and \citet{shleifer1997limits} show that constrained horizons can cause noise-trading to limit the ability of informed traders to take advantage of profitable opportunities for fear of further divergence from fundamental value before realignment is achieved.

The nature of speculation is central to many contemporary questions about international financial markets. For example, regulations or taxes that reduce the amount of speculation may be beneficial if they limit risk-taking and encourage more long-term attitudes towards investment.  If speculation is largely uninformed it will add to the level of noise and maker it even harder for informed-traders to overcome uncertainty and apply fundamental information about long-term value. It will increase the tendency towards activity that is focused on the short-term.  However, if speculation is informed and part of the process of price discovery, regulatory measures may reduce liquidity and undermine the prices of price discovery. Increased volatility, heightened risk and reduced transparency together with other costs may provide an countervailing force. 
  
The rest of the paper proceeds as follows:  Section Two analyses the distinction between informed and uninformed speculators; Section Three discusses the measurement of speculation and the testing of extreme positions; Section Four reviews the evidence; Section Five concludes with a discussion of policy implications. 

\section{Informed and uninformed traders}
Speculation plays an  important role in the areas of market-microstructure, the rationale for the trading of financial securities and rational expectations. However, there is no clear, unambiguous theory of speculation.  While speculation may be vowed as being informed or uninformed, those trading without information are often categorised as being either \emph{noise-traders} or \emph{liquidity traders}.   
  
Noise-trading is associated with psychological biases and restricted information while liquidity-trading is about institutional constraints.  Therefore, noise is associated with behavioural issues, over-confidence and the use of irrational or purely fashionable investment tools. See \citet{DeBondtAnalysts} for an analysis of over-reaction and the \emph{representativeness heuristic}, \citet{OdeanOC} for a study of over-confidence and  \citet{ShillerFashion} for an assessment of investment fads.  Market-participants do not make decisions independently of those made by others. Information is inferred from the activities of others. \citet[p.101]{Keynes1936} said investment decisions could be based on the expectations of others' valuations.  institutional constraints may mean that economic agents just execute customer orders at the current price or it may be that they buy and sell with reference to a benchmark index or to fulfil a hedging strategy. The institutional explanations are associated with the allocation of credit for investment and trading purposes:  as asset values decline exchanges, banks and other providers of liquidity require larger margins and deeper haircuts; investors liquidate their fund holdings; the attraction of hedging increases.  See \citet{BrunnermeierLiquidity} and \citet{Gorton} for some discussion of the way that margin-calls and collateral constraints can force investment decisions.  However, the terms are not fixed and  \citet[p. 1]{GortonNoise} categorise noise-traders as all those trading in markets for ``non-information-based reasons''. 

An important part of microstructure research is the distinction between informed and uninformed traders.  The focus of the \citet{Kyle1985Continuous} model is a market-maker receiving orders from the informed and the uninformed.  On the assumption that uniformed orders arrive in a random fashion, the weight of orders implies something about the knowledge of the informed and should led to adjustment of the bid-ask spread as part of the process of price discovery.  This bid-ask spread is the payment that the market-maker receives from the uninformed in return for taking the risk of meeting an informed trader.  See also \citet{glosten1985bid}.  

As such, Uninformed activity provides a rationale and the opportunity for trading. Unless there is a difference of opinion about value, there is no reason to trade. Uninformed speculation can create space between price and fundamental value that can be exploited by informed speculators.  Indeed, this space can encourage informed traders to pay the cost of acquiring information.  See, for example \citet{Grossman1980Impossibility}. 

\citet[p.529]{BlackNoise} suggested that this interaction of informed and uninformed activity was essential to the smooth functioning of financial markets. Noise, he argued, was the  ``the arbitrary element in expectations''. Therefore, noise makes financial markets possible but imperfect: the more noise-traders that there are, the more liquidity and the easier it is to trade; the more noise-traders, the higher the level of inefficiency in the market and the more likely that price will be driven from fundamental value. 

\citet{EasleyPIN} use information as an explanation for the effect of large orders on stock prices.  The \emph{order effect} may be a consequence of the need to adjust inventories when a market-maker receives a large order; it may also be a function of the market-maker knowledge that large orders are more likely to informed traders seeking to take advantage of their informational advantage.  \citet{EasleyPIN2} develop a technique to estimate the probability that trading is informed.  The find that the high liquidity stocks have the highest level of information and the most frequent arrival rate of informed traders but that this is more than offset by the high quantity of uninformed traders.  Low liquidity stock, by contrast, have fewer information events but informed traders have a much larger effect on prices. 

Informed speculation is also used as the theoretical justification for the tendency of Rational Expectations Equilibrium (REE) to prevail in the long-run.  Those economic agents able to determine the fundamental value or discern the underlying economic model will be able to speculate or sell forecasts that will tend to drive prices towards the equilibrium \citet{muth1961Rational}.  This tends to leave uninformed speculation as a pure noise that can be characterised as white-noise random variable. While this construction may be justified for the analysis of microstructure and market efficiency, it is an over-simplification that is inappropriate when seeking more understanding of speculation itself.  Institutional and psychological explanations for noise-trading frequently suggest that there are endogenous non-random elements to speculative activity.

However, a large proportion of uninformed traders in the market can undermine this process.  \citet{Delong1990noise} and \citet{shleifer1997limits} have presented models where \emph{noise-trader risk} can prevent the arbitrate of informed speculators from driving prices back towards the fundamental value.  The risk that noise-traders will drive prices even further away from equilibrium before the convergence can limit the activity of informed speculators when they are risk averse.\footnote{This three-period, overlapping generation model with informed and uninformed traders has a price equation \begin{equation}
p_t = 1 + \frac{\mu(\rho_t - \rho^*)}{1 + r} + \frac{ \mu \rho^*}{r} - \frac{2 \gamma \mu^2 \sigma_{\rho}^2}{r(1 + r^2)}.
\label{eq:NP2}
\end{equation} 
 where $p_t$ is the price; $\mu$ is the share of uninformed traders; $\rho$ is the price mis-perception of the uninformed traders; $\gamma$ is the level of risk aversion; $\sigma^2_{p,t+1}$ is the variance of the misperception.}   

The De-Long noise-trader model also provides a useful benchmark against which to assess the activity of speculators. The following four effects are noted by \citet[pp. 14-15]{Delong1990noise}:  the \emph{Friedman Effect}, as informed speculators move prices back towards fundamental value; \emph{Price Pressure} is the \emph{noise-trader risk} as the speculative noise-traders drive prices towards their misperceived value; \emph{Hold More} as noise-traders misperceive the value of the risky asset and tend to hold more of it; \emph{Create Space} is the difference between noise-trader perception and the actual value, it creates the opportunity for informed traders to profit from their information. In this model, the more numerous the noise-traders, the more volatile prices.  

The Friedman-effect is the activity of informed speculators.  They take advantage of the space that has been created by the price pressure of the uninformed traders to profit from this mis-pricing.  Uniformed traders tend to hold more when their opinions are strong.  This is the noise-trader risk that can prevent informed traders from fulfilled their arbitrage role. If uninformed traders are very prominent or have strong opinions, prices should show the greatest divergence from fundamental value and the risk of a reversal should be at its greatest.    

\subsection{Empirical work}
Empirical assessment of speculation has been limited by the scarcity of data.  It is not very easy to distinguish between speculators and other types of investors.  It is even harder to distinguish between the informed and uninformed.  One approach has been to assume that noise-traders utilise simple investment strategies and to use tests of these strategies as a means of testing speculation.  Common strategies that have been used are momentum (ref), contrarian (ref) and carry (ref).   It is also possible to assume that certain investors usually have more information than others.  For example, hedge funds, investment banks and other professionals can be assumed to be informed while retail or day traders may be uninformed. 


%It has also been suggested that speculative techniques can change over time.  For example, \citet{ShillerFashion} discusses the use of fashionable techniques or fads in investment.  In this way, speculation can be be associated with sentiment and measures of sentiment are then used as ways of measuring speculation. 

%Noise stragegies may be successful for a while.  Momentum trades tend to be successful for certain ties.  Also discssion the literature on heterogeneous traders, another way that the trading securities is explained, has very frequently used noise-traders as trend-chasers or followers of technical analysis.  These models (see for example brock and hommes [1998]; lux [1995]; lux and marchesi [2000]) investigate bubbles and crashes, and feature fundamental traders versus noise traders. 
\citet{EasleyPIN2} propose a model to try to measure informed market activity based on their assertion that the bid-ask spread is a function of the level of informed trading.  As informed traders are most likely to want to take advantage of their informational advantage, large orders are assumed to be informed.\footnote{With market-makers adopting Bayesian reasoning to update their fundamental valuation by using order flow to estimate the probability that there has been an information event and if there has whether it is good news or bad news, the authors seek to operationalise the following model:
\begin{subequations}
\begin{equation}
...
It is clear that, as speculators become more extreme in their opinion, prices are driven in the direction of sentiment.  It shows that the spot price is following the option risk-reversal skew and, as Figure \ref{fig:ES1} reveals, it would be even more pronounced if the event window just ran from the starting point to the event.  The findings here are consistent with the evidence that orders and sentiment drive prices \citet{Evans2002Order}, \citet{FuturesSanders} and \citet{FuturesWang}. 

What is more interesting is whether knowledge about the extreme reading at time $t = 0$ provides any information about future returns.  If this speculation is noise, Friedman's informed traders should take advantage of that and a reversal should be seen.   This information is provided in columns 5, 8, 11 and 14 of Table \ref{tabref:RR1}. A reversal is indicated by a significant negative reading for highs or positive reading for lows.   Looking, for example, at the four-day window in column 8, it is clear that the extreme risk reversal skew does not provide any information about future returns.  Of the eighteen cases using the 95\% th percentile to identify an extreme, ten show a continuation, rather than a reversal, that is not significantly different from zero; one shows a significant continuation; five show reversals that are not significant; only two show significant reversal (EURCHF in each case).  For the more extreme event when the 99\% the percentile is used to measure the extreme, there is even more ambiguity.  Just over half the cases with the four-day window show a reversal (8 of 18), but only 2 of these are statistically significant.   
...
\end{figure}
% the reference is ES5 to avoid conflict with the earlier version. 
...
However, it does indicate that the evolution of exchange rates are not a random walk.  There is evidence here that prices gradually respond to information, as would be the case if there were institutional or psychological features that caused momentum or gradual adjustment. The positive (or negative) expectations that are evident in the risk reversal skew do not seem to represent a deviation or a mis-pricing that will be reversed.  Rather they seem to be part of the price-discovery process.   
...
Once again, there is a very strong association between returns and the movement of speculators.  For the 4-day window and the S1 and S2 measures, every one of the currencies studied, high and low, had a mean cumulative return for the whole of the event window that was in the same direction as sentiment.  When re-sampled a thousand times, more than ninety five percent of the means calculated were greater than zero in all cases but one (GBP).  Once again there is evidence here of momentum and of speculator positions following the movement of prices. This consistent with both the gradual absorption of information into the price and with the feedback of price into additional speculation.      

However, there is little evidence that these speculators are driving prices to extreme deviations from fundamentals with their extreme behaviour.  Sixty percent of the S1 cases still show a significant abnormal return in the direction of the extreme 4 weeks after the extreme has been reached; only thirty percent of the cases show a reversal and in only one of those do ninety five percent of the re-sampled means remain above zero.  For S2 there is even less ambiguity, with ninety percent of the cases showing a continuation and forty percent of them being significant.  Again the evidence is consistent with the gradual adjustment of prices to information. 
...
The event windows are stretched to give a clear view of the evolution of exchange rates  around the event and to ensure that results are not a function of the size of the event window.  Confidence intervals are added\footnote{It is possible to make changes to the estimate of the \emph{expected exchange rate}, the extreme measurement, quantile, window length and the high or low indicator and for alternative assessments of speculative extremes to be used. Adjustments to these parameters show that these results are not a function of the choices presented in the main text.  They are robust to alternative specifications.}. 

Figure \ref{fig:ES3} shows the performance of the cumulative abnormal returns around a six week event window where the event is the net low (short) speculative positions relative to total activity (open interest) at or below the ($5\%)$ level.  This means that the speculators are inclined to be short the non-domestic (US dollar) currency.  While the Euro continues to move lower after the extreme short positions, the other major currencies move broadly sideways, consistent with the settlement around an equilibrium after a period where information is being absorbed.  This is also consistent with market efficiency where a random walk would be expected after an extreme. 

Figure \ref{fig:ES4} shows the abnormal returns around extreme high (90th percentile and long position).  There is some tentative evidence of continuation for speculative positions in the Canadian dollar and signs of reversal for UK sterling.  However, the Euro and the Japanese yen move sideways after the event.  There is no clear pattern after the extreme and therefore no information.  

\section{Speculation and foreign exchange returns}
This paper has sought to measure speculation and to use this measure to discover more about the relationship between speculation, information and asset prices.  
Whether measured as intensity of speculative sentiment or as the weight of speculator action, it is clear that extreme speculation does not provide information about future returns.  This means that speculation is more likely to be informed than uninformed.  If it were uninformed it would be much more likely that these extremes would be follow by reversals as informed market participants took advantage of the space created by this uninformed speculative activity. 

The possibility that noise-trader risk limits the activity of informed traders is limited by the large windows that are employed when constructing figures for the event study.  Informed traders may fear the uninformed in the short-run and this may delay the chance of a reversal but over the medium-term reversals would be expected.  This event study uses 20 days and 6 weeks for the daily and weekly event windows.  

The nature speculation is central to a number of contemporary policy questions.  Amongst these are the design and regulation of financial markets, the surge in commodity prices and the limits put on the activities of financial institutions. The debate about a tax on financial transactions, initiated by \citet{TobinTax} and now called the \emph{the Tobin tax}, has been intended to reduce speculation. The argument for a tax on financial transactions depends on the idea that speculators will drive the price away from its fundamental value. However, if speculation is part of the process of price discovery, reducing its activity may incur costs that offset some of the benefits that are expected.      
  
The reduction in speculation in the US government bond market that has been seen since the introduction of new costs and restrictions under the array of ???? regulations has been seen by some to reduce liquidity and increase volatility, rising risk and imposing additional costs for final investors.  

The surge in commodities prices that was seen prior to the GFC was seen to be partially the consequence of increased speculation in commodities and the creation of exchange traded funds (ETF) focusing on commodities markets. Even if speculators are on both side of the market and not driving prices in one direction, they may still increase the amount of volatility, incurring costs for producers and consumers of underlying materials.   
...
\section{Appendix 1}\label{apref:1}

\begin{sidewaystable}
\begin{threeparttable}
\caption{Appendix 1: Descriptive Statistics for Risk Reversals: 2 January 1996 to 6 September 2002}
...
\begin{sidewaystable}
\begin{threeparttable}
\caption{Appendix 2: Descriptive Statistics for S1 (Speculative Sentiment) and S2 (Speculative Weight): 30 September 1998 to 31 December 2008}
\begin{tabular}{l | r r r r r r r  r r r }
  \hline
