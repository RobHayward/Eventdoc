...
Regulatory changes in the US government bond market give some idea about way that a reduction in speculation can affect the smooth functioning of financial markets. Increased capital requirements and the so-called \emph{Volcker Rule} that would prevent investment banks from trading on their own account have raised the cost of trading US government bonds and reduced the ability of some key players to participate in the market. Though bid-ask spreads have remained stable, the New York Federal Reserve reports that \emph{market-depth} and the \emph{price impact} of large trades has deteriorated in the last two years. \footnote{See New York Fed citation for an assessment of the evolution of bid-ask spreads, price impact and the size of trades.  }  This is regarded as one of the reason that volatility has increased at times of tension and as liquidty has evaporated and large price changes have been recorded. 
%@misc{NTFedbonds, 
...
%  publisher = {Federal Researve Bank of New York},
