...
There are a range of ideas about the way that speculation can affect financial markets.  Towards one end of this spectrum is the view of  \citet[p. 101]{Keynes1936} in Chapter 12 of \emph{The General Theory} where he identified speculation as a myopic, sentiment-driven activity, dominated by the desire to ``beat the gun'' or  ``outwit the crowd''. Here speculation is a problem that, at its most extreme, will cause booms, reversals and will discourage fundamental, long-term investment. It is noise that does not emerge randomly, but feeds off itself in an evolution of collective sentiment that encourages trends in asset prices.

Towards the other end of the spectrum, Milton Friedman argued that speculation was a stabilising force, providing liquidity and helping to ensure that markets swiftly find equilibrium. In arguing in favour of flexible exchange rates,  \citet{FriedmanPositive} asserted that successful speculators would be those who managed to correctly buy when prices  were below fundamental value and sell above that price. Therefore, Friedman argued, the speculative process would favour those able to access or utilise information over the uninformed and, through a Darwinian process, informed speculation would dominate.  This view regards speculation as an key lubricant of financial markets as it provides liquidity and facilitates the process of price discovery.   
...
The foreign exchange market is utilised because it is the largest and most liquid financial market in the world.  The latest survey taken by the Bank for International Settlements (BIS) in April 2013 estimated average daily turnover at \$5.4trn with average daily spot transactions of \$2.0trn See \citet{BISFX2013}.  The cost of trading in this market, when measured in terms of the size of the bid-ask spread, is extremely low. An analysis by \citet{Steely2013} of the bid-ask spreads for USD-JPY, GBP-USD and EUR-USD for the period January 2001 to 2005 and finds that the average spread for each is 0.342\%, 0.305\% and 0.326\% respectively.  This would be the cost for a round-trip (buying and selling immediately). 
    
A unique set of option prices are used to identify the intensity of speculative sentiment.  US regulatory positions measure the prominence of speculators in the market. Speculation does not appear to be random, there is momentum to the rise and fall in sentiment and positions.  However, while currency prices co-move with sentiment and positions, there is no informational content from either: knowing  the strength of speculative opinion or the weight of speculative positions does not improve forecasts of future returns. This supports the suggestion that speculative activity has a permanent affect on prices and that is consistent with speculation being part of the process of price discovery. Speculators do not seem to drive prices from fundamental value and their presence seems to help rather than hinder the incorporation of information into prices. 

\section{Literature}
\subsection*{Overview}
  Speculation is an important concept in economics, particular in the area of finance.  However, there is no clear, unambiguous theory of speculation. Speculation plays a key role in three important and related areas: market-microstructure, the rationale for the trading of financial securities and rational expectations. 
  
One key element of the microstructure literature involves distinguishing between uninformed or noise-traders and those who have information. The \citet{Kyle1985Continuous} model has market-makers receiving orders from the informed and the uninformed.  On the assumption that the uniformed arrive in a random fashion without any reason to trade, the weight of orders implies something about the activity of the informed and causes prices to change in the process of price discovery.  The bid-ask spread is the payment that the market-maker receives in return for taking the risk of meeting an informed trader.  Ultimately, the uninformed traders make payments to the informed traders with the market-makers taking a cut for the risk and the provision of exchange.  See also \citet{glosten1985bid}.  

In the \emph{microstructure} literature, the term noise-trader is often interchanged with \emph{liquidity-trader}.  There may be institutional and psychological reasons for the lack of attention to fundamental information. Nonetheless, liquidity tends to refer to institutional explanations for trading without reference to fundamental value. This may mean that economic agents just execute customer orders at the current price or it may be that they buy and sell with reference to a benchmark index or to fulfil a hedging strategy. Noise is more psychological. 

\citet[p. 1]{GortonNoise} categorise noise-traders as all those trading in markets for ``non-information-based reasons''. In this case, uninformed speculation provides a rational and an opportunity for the trading of financial securities. There must be different opinions.  Why will traders be prepared to pay the cost of acquiring information if they are unable to take advantage of that information? With speculative noise-traders, prepared to take the other side of the transaction, the informed can take advantage of their information.  This creates a justification for acquiring information. Speculative noise-traders can therefore create a gap between the price and the fundamental value that will encourage informed traders to pay the cost of acquiring information.   \citet[p.529]{BlackNoise} suggested that this combination was essential to the smooth function of financial markets. It is ``the arbitrary element in expectations''. Therefore, noise makes financial markets possible but imperfect: the more noise-traders that there are, the more liquidity and the easier it is to trade; the more noise-traders, the higher the level of inefficiency in the market and the more likely that price will be driven from fundamental value. This begs the question: are speculators trading on noise or are they informed?  

  Speculation is also an important part of the argument for why prices should tend towards a level that consistent with \emph{the rational expectations equilibrium} (RER). This is the level that is consistent with rational expectations.  In the original version of rational expectations,  \citet{muth1961Rational} uses commodity speculation as the means by which prices are driven towards the level where expectations are model-consistent. These are of Friedman-type speculators as they base their expectations on their knowledge of the underlying model and they are the mechanism through which equilibrium is achieved. 

However, though equating noise and noise-trading as a random variable may be a construction that is useful for modelling and it may be justified in analysis of broader themes of microstructure and levels of market efficiency, it may also be an over-simplification that is inappropriate when looking for more understanding of speculation itself.  Institutional and psychological explanations for noise-trading frequently suggest that there are endogenous non-random elements to speculative activity.

  The institutional explanations are associated with the allocation of credit for investment and trading purposes:  as asset values decline exchanges, banks and other providers of liquidity require larger margins and deeper haircuts; investors liquidate their fund holdings; the attraction of hedging increases.  See \citet{BrunnermeierLiquidity} and \citet{Gorton} for an overview of the institutional literature.  Psychological explanations revolve around the common panic, the group-thinking and the tendency to read private information into the actions of other investors: the so-called \emph{wisdom of crowds} depends on independent evaluation but as Keynes noted in his discussion of the \emph{beauty contest}, it is generally more important to identify what other investors will believe than to form an independent view of the actual underlying, fundamental value \citet[p.101]{Keynes1936}.

\subsection{Empirical work}
Empirical assessment of speculation has been limited by the scarcity of data.  It is not very easy to distinguish between speculators and other types of investors.  It is even harder to distinguish those that may be noise-traders from those assumed to be informed.  One approach has been to assume that noise-traders utilise simple investment strategies and to use tests of these strategies as a means of testing speculation.  For example speculation can be identified with momentum trading. It is also possible to assume that certain investors, such as investment banks and hedge funds, are informed while other trade without information. The latter group may include day-traders or private individuals.  
...
%Noise stragegies may be successful for a while.  Momentum trades tend to be successful for certain ties.  Also discussion the literature on heterogeneous traders, another way that the trading securities is explained, has very frequently used noise-traders as trend-chasers or followers of technical analysis.  These models (see for example brock and hommes [1998]; lux [1995]; lux and marchesi [2000]) investigate bubbles and crashes, and feature fundamental traders versus noise traders. 

\subsection{Why this is important}
The Keynesian view of speculation is that it is an addition to market noise that makes it even harder for informed-traders to overcome uncertainty and apply fundamental information about long-term value. As such, it exacerbates the tendency towards putting too much emphasis on the immediate and works against longer-term and strategic thinking.  This description provides an explanation for the observation from \citet{ShillerVol} that stock prices are more volatile than the underlying earnings information on which valuation should be based. In addition, \citet{Delong1990noise} and \citet{shleifer1997limits} show that constrained horizons can cause noise-trading to limit the ability of informed traders to take advantage of profitable opportunities for fear of further divergence from fundamental value before realignment is achieved.

The nature of speculation and the role of noise-traders has become increasingly important since the global financial crisis (GFC).  There are a number of contemporary questions where the role and nature of speculation is at the centre of the debate.  For example, regulations or taxes that reduce the amount of speculation have generally been considered to be beneficial as they limit risk-taking and encourage more long-term attitudes towards investment.  However, where these measures reduce liquidity, higher risk and an increase in other costs may provide an countervailing force. 
  
The debate about a tax on financial transactions, initiated by \citet{TobinTax} and now called the \emph{the Tobin tax}, has been intended to reduce speculation.  The surge in commodities prices that was seen prior to the GFC was seen to be partially the consequence of increased speculation in commodities and the creation of exchange traded funds (ETF) focusing on commodities markets.  The argument for a tax on financial transactions depends on the idea that speculators will drive the price away from its fundamental value.   

%volcker rule?

\section{Methodology}
The aim of this study is to test whether the noise-trader model provides an appropriate explanation for speculator activity in the foreign exchange market.  The analysis will involve three steps:  assessment of the price implication of the noise-trader model;  measurement of speculative activity in the foreign exchange market; finally, assessment of whether extreme speculative market activity is consistent with the underlying model that is used.  If the speculative activity in the foreign exchange market produces results that are like the noise-trader model, it can be said that speculation is closer to the Keynesian view than that of Friedman.  

The \citet{Delong1990noise} noise-trader model used in this study. This is a derivative of the \citet{Samuelson1958} overlapping generations model with two-period agents making a portfolio choice between two assets: a safe asset $(s)$ which pays a set dividend $(d)$ and is in perfectly elastic supply; a risky asset $(u)$ which also pays the same dividend but is not in elastic supply.  There are two types of investor: sophisticated traders $(i)$ who know the fundamental value of the risky assets and noise-traders $(n)$ who misperceive the fundamental value.  In the absence of noise-traders, the assets are substitutes.  Each trader chooses their portfolio in the first period $(t)$ to maximise their utility on the basis of their belief about the price of the unsafe asset in the second period $(t + 1)$.  The representative noise-trader mistakes the price of the risky asset by a random variable 

\begin{equation}
\rho_t \sim N(\rho^*, \sigma_{\rho^2})
\end{equation}

Maximising utility with respect to holdings of the sage and risky assets for the informed and uninformed traders and iterating backward to solve for the current value,  the price becomes the discounted value of the future dividends, the expected capital gain and the general misperception of noise-traders less risk.  
...
The deviation from the true fundamental value of unity is a result of the discounted value of the noise-traders' misperception of the price $(p_t - \rho^*)$, multiplied by the weight of noise-traders in the total $(\mu)$ plus a perpetuity of the average noise-trader misperception $(\frac{ \mu \rho^*}{r} )$, adjusted for the risk.   This risk is a function of the volatility of the price which,  from Equation \ref{eq:NP1} is a consequence of the variability of the misperception of speculative noise-traders.   All but the second term in equation \ref{eq:NP1} are constants, and if the variance of the price one period ahead  is equal to the variance of the misperception, 
...
The Friedman-effect and the Price-pressure are the effects that are studied here.  Their combination suggests that when the weight of noise-traders is high or the times when they have particularly strong opinions will tend to be those when there is the greatest risk of reversal.  The hold-more effect suggests that the weight of speculative involvement in the market will tend to increase as a trend.  Create-space effect would suggest that when the weight of noise-traders is high and extreme, there is greater incentive and opportunity for the informed to take advantage of the divergence between fundamental value and price. 

\subsection{The implications of the noise-trader model}
There are two parameters from the noise-trader price equation \ref{eq:NP2} that can be used to measure the amount of speculation:  the price misperception $(\rho)$ and the weight of noise-traders in the market $(\mu)$.  The aim of this section is to  identify the returns that are implied by the noise-trader model when either the intensity of the misperception or the weight of noise-traders is increased to extreme levels so that this can be used as a benchmark against which foreign exchange market activity can be judged. 

To understand what the noise-trader model of speculative behaviour means for foreign exchange rates, a \emph{Monte Carlo} simulation is carried out with a variety of misperception-perceptions and noise-trader weights.  Two time series are created.  The first series is based on a random noise-trade misperception, $(\rho^*)$.  This is called the Misperception Model (MPM). The second is based on a random weight of noise-traders $(\mu)$ and is called the Random Weight Model (RWM).   The simulation creates a 1000 period price series from Equation \ref{eq:NP2}. The dividend paid on the risky asset $(r)$ is posted at 10\%; the risk-aversion parameter $(\gamma)$ is assumed to be 0.3 (in line with that suggested in \citet[p. 127]{FrobesBehaviour}); starting from a price of 100, the average noise-trader misconception $(p^*)$ is a random variable in the first simulation with a mean of 4 and a variance $(\sigma_{\rho^*}^2)$ of 2, and has a fixed value of 4 in the second simulation; the weight of noise-traders $(\mu)$ is 50\% in the first case but is modelled as a two-period moving average of a normal random variable centred at 50\% with a standard deviation of 20\% and equally weighted average of its previous value (starting at 50\%) to allow smooth adjustment, in the second simulation.   
% it is possible to have other specifications. For example, the noise-traders oculd become more prominent if their strategy is more successful, 

A 1000 period prices simulation is created for each model and the returns for these series are calculated as the log change in price.  Those periods when misperception-perception or the weight of speculators is \emph{extreme} are identified as those that are at or above the ninety-fifth percentile.  These extremes are the \emph{event} for an event study. Descriptive statistics for the whole series of returns and for those when either the extent of their misperception or the weight of noise-traders is extreme are presented in Table \ref{tabref:MC1}.  The process is then repeated for one thousand simulations of each model so that confidence intervals can be established for the estimates of the descriptive statistics.        
...
\begin{tablenotes}
\small
\item Descriptive statistics for the De Long Noise-Trader model \citet{Delong1990noise}.  The Base Case measures the benchmark as returns from prices generated by Equation \ref{eq:NP2} for the whole sample.   The MPM measures returns after a period of extreme sentiment when the misperception of noise-traders ($\rho$) is equal to or above the 95th percentile of all the misperceptions; the RMW measures the returns following a recording of extreme weight of noise-traders ($\mu$) is equal to or above the 95th percentile of all noise-trader realisations.   The asterisk denotes significantly different from zero at the 95th confidence interval.    
\end{tablenotes}
\end{threeparttable}
\end{table}
...
This paper has sought to measure speculation and to use this measure to discover more about the relationship between speculation, information and asset prices.  The measurement of speculation takes two forms:  a measurement of the intensity of belief with the risk-reversal skew, and a measurement of speculative positions.  The option prices reveal the intensity of feeling through the weight of money in a speculative part (options) of a speculative market (foreign exchange).  The commitment of traders report records only speculators in the US futures market.  However, this is an important market, there is no reason to believe that US speculators in the futures market are systematically different from those in the rest of the world and presumably if there were a major difference there would be an arbitrage opportunity between the two markets.  

There is strong evidence that speculation affects prices and that this effect is gradual rather than instantaneous.  This consistent with a market inefficiency that would reward momentum-based trading.  It is no wonder therefore that \citet{TaylorTechnical}, reporting a survey conducted by the Bank of England, found that of the Chief foreign exchange dealers contacted in London in November 1988, 90\% of them attached some weight to \emph{technical analysis}, a method that is fundamentally based on finding trends in asset prices.  The survey found that the importance of technical analysis became greater at shorter horizons.  The importance of momentum trading and technical analysis has not waned with time.  The more up-to-date CFTC data show the same pattern.  In addition,  \citet{NeelyWeller} show that gains from technical trading rules still generate excess returns and attribute this to behavioural biases. It seems that speculation forms part of the process of price discovery, but this process is not instantaneous as would be expected if the market were informationally efficient.   
...
\begin{tablenotes}
\small
\item Continuously compounded returns (multiplied by 100) for period 2 January 1996 to  September 2002 for US dollar per unit of Australian dollar (AUD), UK sterling per unit of Euro (EURGBP), Swedish Crown per unit of EUR (EURSEK); US dollar per unit of UK sterling (GBP);  Swiss franc per unit of US dollar (CHF); Swiss franc per unit of Euro (EURCHF); US dollars per unit of Euro (EUR); Canadian dollars per unit of US dollar (CAD); Japanese yen per unit of US dollars (JPY). The asterisk (*) means that the estimate is significantly different from zero at the 5\% level using t-statistics for the mean and the standard error of skew and standard error of excess-kurtosis respectively.    
\end{tablenotes}
\end{threeparttable}
\end{sidewaystable}
