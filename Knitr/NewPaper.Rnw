...
This paper contributes to the debate about the nature of speculation in a number of ways. A unique set of option prices are used to identify the intensity of speculative sentiment; an event study method is used to establish the effect of extremes of speculative sentiment and speculative positions; these speculative extremes are compared to a common noise-trader model.  Speculative extremes do not provide information about the future; the evolution of foreign exchange prices after an extreme can be characterised as a random walk. However, extremes are followed by an increase in the variance of exchange rate returns. This suggests that information from informed speculation contributes to the process of price discovery.
...
The nature of speculation is central to many contemporary questions about international financial markets. For example, regulations or taxes that reduce the amount of speculation may be beneficial if they limit risk-taking and encourage more long-term attitudes towards investment.  If speculation is largely uninformed it will add to the level of noise and make it even harder for informed investors to overcome uncertainty and apply fundamental analysis about long-term value; will increase the tendency towards activity that is focused on the short-term.  However, if speculation is informed and part of the process of price discovery, regulatory measures to reduce its influence may also reduce liquidity and undermine the prices of price discovery. Increased volatility, heightened risk and reduced transparency together with other costs may provide a counteraction to any positive benefits.  
  
The rest of the paper proceeds as follows:  Section Two discusses the distinction between informed and uninformed speculators; Section Three talks about the measurement of speculation and the testing of extreme positions; Section Four reviews the evidence; Section Five concludes with a discussion of policy implications. 

\section{Informed and uninformed traders}
Speculation plays an  important role in the areas of market-microstructure, the rationale for the trading of financial securities as well as providing the explanation for rational expectations are supposed to operate. However, there is no clear, unambiguous theory of speculation.  Speculation is frequently associated with the term \emph{trading}, but trading is broader as it encompasses market-making. A distinction made between the short-term orientation of speculation and trading and the more long-term activity of investment.   Speculation and trading can be categorised as being informed or uninformed. Those trading without information are also called \emph{noise-traders} or \emph{liquidity traders}.  However, the terms are not fixed and  \citet[p. 1]{GortonNoise} categorise noise-traders as all those trading in markets for ``non-information-based reasons''. 
%these two paragraphs above may go later and just a very short coverage of the distinction between noise-traders and liquidity traders. 
The distinction between informed and uninformed traders is a central component of microstructure research.  The focus of the \citet{Kyle1985Continuous} model is a market-maker receiving orders from the informed and the uninformed.  On the assumption that uniformed orders arrive in a random fashion, the weight of orders implies something about the knowledge of the informed and should led to adjustment of the bid-ask spread as part of the process of price discovery.  This bid-ask spread is the payment that the market-maker receives from the uninformed in return for taking the risk of meeting an informed trader.  In a similar way \citet{glosten1985bid}describes a model where the bid-ask spread is a function of adverse selection, being caused by the risk that orders come from informed traders.  
...
\subsection{Results for extreme speculative sentiment}
...
As speculators become more extreme in their opinion, exchange rates are driven in the direction of sentiment. Looking down the seventh column (the 4-day CARW) shows the average cumulative return for the period from four days before the extreme event to the four days after the extreme for extreme sentiment highs and lows of each currency pair.   The extreme highs are (in this case) those points when the risk-reversal skew is at or above the 95th percentile.  For the whole event window (CARW), extreme highs (labelled "Hi") are associated with positive returns and the extreme lows (labelled "Lo") are associated with negative returns. In most cases these positive and negative returns appear to be statistically significant. Significance is identified as those cases where more than 95\% of 1000 random bootstrap samples taken from the events being above zero. Mean values of the cumulative returns are calculated from samples of the event days and the distribution of these means are used to construct the confidence intervals.  Returns that are statistically different from zero are identified by an asterisk. 
...
That sentiment drives price is shows that speculators have influence on the market.   This is consistent with the evidence of previous research from the likes of \citet{Evans2002Order}, \citet{FuturesSanders} and \citet{FuturesWang} that orders and sentiment drive prices.  What is more interesting is whether knowledge about the extreme reading at time $t = 0$ provides any information about future returns.  If this speculation is noise, informed traders should take advantage of the space that has been created between the price and the fundamental value and a reversal should be seen.  Whether this is the case is recorded in columns 5, 8, 11 and 14 of Table \ref{tabref:RR1}. A reversal is indicated by a significant negative reading for highs or positive reading for lows.   Looking, for example, at the four-day window in column 8, it is clear that the extreme risk reversal skew does not provide any information about future returns.  Of the eighteen cases using the 95\% th percentile to identify an extreme, ten show a continuation rather than a reversal that is not significantly different from zero; one shows a significant continuation; five show reversals that are not significant; only two show significant reversal (EURCHF in each case).  For the more extreme event when the 99\% the percentile is used to measure the extreme, there is even more ambiguity.  Just over half the cases with the four-day window show a reversal (8 of 18), but only 2 of these are statistically significant. Exchange rate prices are as likely to go up as down after an extreme and there does not appear to be any information about the future from knowledge of these extremes.  
\begin{figure}
\graphicspath{{../Figures/}}
\centering
\includegraphics[scale=0.8]{RRCum16}
...
Though it appears that the speculation in examples is informed, it is clear from figures \ref{fig:ES1} and \ref{fig:ES2} that exchange rates do not react instantly to the news.  There is a gradual evolution.  This is consistent with the evidence of serial correlation in asset prices that has been identified.  See, for example, \citet{Jagadeesh}.  It appears that information is gradually absorbed into the price.\footnote{It may be that exchange rate traders take time to adjust to the information that comes from order flow or it may be evidence of the \emph{conservatism heuristic} that suggests that people are slow to change their opinion to new information.}  

It is also possible to look at the distribution exchange rate returns after these extremes and to compare them to the distribution of the whole sample.  If speculation is informed, we expect to see a distribution of return that is largely symmetrical around zero and very similar to the distribution for the whole sample. The distribution of return is very similar but, but much broader than that of the whole distribution.  Conventionally, this would suggest that there is greater risk.  It may be that the increase in information adds to the level of uncertainty in the market. 
% Add the table with the descriptive statistics for returns that follow an extreme compared to the whole sample. 
\subsection{Results for extreme speculative positions}
...
\caption{Event Study:  Extreme (95th percentile), Non-commercial net short per OI (S2), 6 week event window.  Non-commercial net per OI (S2) are the net speculative positions (as reported to US regulator the CFTC) relative to all open positions; extreme low is the highest 95th percentile for the whole range, cumulative returns are the sum of log exchange rate returns. The event day is the day of the extreme risk reversal reading as a measure of extreme speculative activity.  If speculation is uninformed, extremes should be followed by reversals; if speculation is informed, extremes are more likely to be followed by a random walk.}
\label{fig:ES3}
\end{figure}
...
\caption{Event Study:  Extreme (90th percentile), Non-commercial net long (S1), 6 week window. Non-commercial net per OI (S2) are the net speculative positions (as reported to US regulator the CFTC) relative to all open positions; extreme high is the highest 95th percentile for the whole range, cumulative returns are the sum of log exchange rate returns. The event day is the day of the extreme risk reversal reading as a measure of extreme speculative activity.  If speculation is uninformed, extremes should be followed by reversals; if speculation is informed, extremes are more likely to be followed by a random walk.}
\label{fig:ES4}
\end{figure}

There is little evidence that these self-reported speculators are driving prices away from fundamentals with their activity. Sixty percent of the S1 cases still show a significant abnormal return in the direction of the extreme 4 weeks after the extreme has been reached; only thirty percent of the cases show a reversal and in only one of those do ninety five percent of the re-sampled means remain above zero.  For S2 there is even less ambiguity, with ninety percent of the cases showing a continuation and forty percent of them being significant.  The evidence here with speculative positions is the same as that of speculative sentiment.  Prices move in the direction of speculative activity but speculative extremes do not provide information about the future. The price action of the event study is consistent with speculation being informed rather than uninformed.   

Figures \ref{fig:ES3} and \ref{fig:ES4} indicate that these results are not a function of the event window that has been chosen.  Looking at the 95 percentile confidence intervals (once again constructed by bootstrap re-sampling) indicates that in all the cases, there is a large amount of uncertainty about the future direction well after the extreme reading of speculative activity.  It does not appear that informed traders are constrained in the short-run from driving prices back to equilibrium.  It appears that the informed traders are driving prices to a new level. 

\section{Speculation and foreign exchange returns}
The nature speculative activity in financial markets is central to a number of contemporary policy questions.  Amongst these are the design and regulation of financial markets, the surge in commodity prices and the limits put on the activities of financial institutions. The debate about a tax on financial transactions, initiated by \citet{TobinTax} and now called the \emph{the Tobin tax}, has been intended to reduce speculation. This is based on the belief that speculation is uninformed, that it drive prices away from their fundamental value and as a consequence  increases the volatility of financial asset prices. The argument for a tax on financial transactions can be presented as a tax on an externality with the level of volatility of financial markets being the public cost.  

The increase in volatility that is evident when speculative activity is high seems to provide some support to this argument.  However, it is not clear that the direction of causality is from speculation to volatility.  An alternative view would suggest that an increase in information raises the amount of informed speculation and that this increase in information naturally increase the volatility of financial assets. If speculation is part of the process of price discovery, reducing its activity may reduce liquidity and hinder the process of price discovery.  In that case unanticipated costs may offset some of the benefits that are expected from the tax on speculation.      
  
Regulatory changes in the US government bond market give some hints at the way that reduce speculation can affect the smooth functioning of markets.\footnote{Increased capital requirements and the so-called \emph{Volcker Rule} that would prevent investment banks from trading on their own account have increased the cost of trading US government bonds and reduced the ability of some key players to participate in the market.}  Though bid-ask spreads have remained rather stable, the \emph{market-depth} and the \emph{price impact} of large trades has deteriorated in the last two years.  There have also been a number of occasions where very large price changes and an evaporation of liquidity have affected the market. 
...
Whether measured as speculative sentiment or as the weight of speculator action, it is clear that extreme speculation does not provide information about future returns.  This means that speculation is more likely to be informed than uninformed.  If it were uninformed it would be much more likely that these extremes would be follow by reversals as informed market participants took advantage of the space created by this uninformed speculative activity. 
