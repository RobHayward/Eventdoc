...
Fisher Black suggested that this combination was essential to the smooth function of financial markets. It is ``the arbitrary element in expectations'' \citet[p.529]{BlackNoise}. Therefore, noise makes financial markets possible but imperfect: the more noise-traders that there are, the more liquidity and the easier it is to trade; the more noise-traders, the higher the level of inefficiency in the market and the more likely that price will be driven from fundamental value. 
  ...
  Speculation is also an important part of the argument for why prices should tend towards that consistent with \emph{rational expectations}.  \citet{muth1961} uses commodity speculation to argue for model-consistent expectation formation.  In this case, the speculators are informed and tend to reduce the volatility of prices.    
